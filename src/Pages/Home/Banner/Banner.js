        ...
        <section className="">
            <div className="container grid md:grid-cols-5 p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left col-span-2">
                    ...
                    <p className="mt-6 mb-8 text-lg sm:mb-12">Travelling will inevitably make you more independent and confident. You will realise that you can cope with a lot of unexpected situations.</p>
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                        <Link><Button variant='text' to='' className="px-8 py-3 text-lg font-semibold rounded bg-violet-400 text-gray-900">Explore</Button></Link>
                        <Link><Button variant='gradient' to='' className="px-8 py-3 text-lg font-semibold border rounded">Reviews</Button></Link>
                    </div>
                </div>
