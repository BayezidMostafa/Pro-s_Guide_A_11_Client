...
const Review = ({ review }) => {
    const { picture, name, email, review_comment } = review;
    return (
            ...
            <div className="relative flex gap-4">
                ...
                <div className="flex flex-col w-full">
                    <div className="md:flex flex-row justify-between">
                        ...
                        <FaTimes className='text-red-400 text-2xl cursor-pointer hover:text-red-700 duration-150 bg-gray-200 rounded bg:shadow-md shadow-black' />
                        {/* <p>Rating: {rating}</p> */}
                    </div>
